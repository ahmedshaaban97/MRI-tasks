...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 110, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        self.gridLayout.addItem(spacerItem1, 0, 1, 1, 1)
        self.graphicsView_phantom = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView_phantom.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 255));")
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.graphicsView_phantom.setBackgroundBrush(brush)
        ...
        self.graphicsView_seq1.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 255));")
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        self.graphicsView_seq1.setBackgroundBrush(brush)
        self.graphicsView_seq1.setObjectName("graphicsView_seq1")
        self.gridLayout_4.addWidget(self.graphicsView_seq1, 1, 1, 1, 1)
        ...
        self.graphicsView_seq2.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(0, 0, 0, 255));")
        self.graphicsView_seq2.setObjectName("graphicsView_seq2")
        self.gridLayout_5.addWidget(self.graphicsView_seq2, 1, 1, 1, 1)
